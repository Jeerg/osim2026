...
/**
 * shadcn-style Dialog — Phase-1-Subset.
 *
 * Wrap um @radix-ui/react-dialog (https://ui.shadcn.com/docs/components/dialog).
 * Konsumenten:
 * - OCtrlColorRef (Popup mit Color-Picker)
 * - OCtrlList (Dialog für Klassenauswahl beim "Hinzufügen")
 * - PGObjBaseViewer (in Plan 08 modale Property-Editor-Variante)
 */
