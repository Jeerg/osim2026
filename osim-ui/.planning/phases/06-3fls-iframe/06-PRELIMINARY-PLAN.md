# Phase 6 — 3fls-Integration via Iframe-Embedding
...
- **A: Geteilter Firebase-Projekt-Token** — Host und Sub-App nutzen denselben Firebase-Tenant; ID-Token kann direkt weitergereicht werden. Setzt voraus, dass osim-ui im selben Firebase-Projekt wie 3fls deployt ist — widerspricht der Festlegung "eigenes GCP-Projekt" aus Phase 4.
...
| Risiko | Mitigation |
|---|---|
| 3fls-Stack ist evtl. nicht bereit für Iframe-Hosting (CSP/SameSite Cookies) | Frühzeitig prüfen, ggf. 3fls-Anpassung in Phase 6 mit-einbauen |
...
| URL-Tiefe-Verlinkung ("Direkt-Link auf eine Sim-Live-Seite in 3fls-Kontext") | Iframe-URL-Sync über PostMessage (Phase 6.5 oder Backlog) |
...
1. **Auth-Bridge-Variante:** A (geteiltes Firebase-Projekt — widerspricht Phase 4) oder B (On-Behalf-Exchange — konform). Empfehlung B.
