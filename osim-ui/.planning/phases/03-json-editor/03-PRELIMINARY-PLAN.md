# Phase 3 — JSON-Modell-Schema via Engine-Reflection + minimaler Form-Editor

**Milestone:** v0.1.0
**Stand:** 2026-05-20 (Entwurf, umgenummert auf Phase 3 nach Roadmap-Resync 2026-05-21)
**Aufwand-Schätzung:** 2–3 Wochen (1 Dev), davon ~1 Woche enge Engine-Koordination
**Depends on:** Phase 1 (OViewer als alternativer Editier-Pfad), Phase 2 (Sim-Lauf zum Simulieren neu angelegter Modelle)
...
6. ✅ Das gespeicherte Modell kann mit dem Phase-2-Sim-Submit-Flow **erfolgreich simuliert** werden (Vollständigkeit der Reflection).
...
Phase 3 ist **nicht** ohne Engine-Erweiterung möglich. Folgende Arbeiten müssen im `osim-engine`-Repo passieren:
...
Diese Tasks sind **Voraussetzung** für osim-ui Phase 3. Empfehlung: vor Start von Phase 3 ein Engine-Sprint einlegen, der E2.1–E2.6 fertigstellt.
...
- Visueller Drag-and-Drop-Editor (→ Phase 8+ Backlog)
- Modell-Templates ("Wizard für neues Fertigungssystem") — könnte Phase 6 sein
...
- Inline-Vorschau des entstehenden Modell-Graphen (das macht Phase 4 Live-Viz)
