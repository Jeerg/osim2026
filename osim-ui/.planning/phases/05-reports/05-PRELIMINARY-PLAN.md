...
| 1.5 | Multi-Run-Aggregator: `GET /api/v1/multi-runs/{id}/kpis` mit Mean/Median/CI | 1.3, Phase 4 |
...
## 5. Reuse aus Phase 3 (GraphObject-Foundation)

Reports können (optional) den **Durchlaufplan-Graphen als Bild** enthalten. Dafür nutzen wir die GraphObject-Foundation aus Phase 3:
...
- Vergleichs-Report über mehrere Modelle (→ Backlog, mögliche Phase 5.5)
