# Phase 5 — Parallel-Runs + Cloud-Deployment (eigenes GCP-Projekt)

**Milestone:** v0.1.0
**Stand:** 2026-05-20 (Entwurf, umgenummert auf Phase 5 nach Roadmap-Resync 2026-05-21)
**Aufwand-Schätzung:** 2–3 Wochen (1 Dev) inkl. Infra-Aufbau
**Voraussetzungen:** Phase 4 (Live-Viz mit WebSocket — wird auf Pub/Sub umgestellt)

---

## 1. Ziel der Phase

Aus dem Single-Host-MVP (Phasen 1–4) wird eine **horizontal skalierbare Cloud-Anwendung** mit:
...
- 3fls-Integration (→ Phase 7, eigene Phase)
